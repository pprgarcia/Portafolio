...
`,
    ...
    },
    {
      ...
      category: "Power BI",
      description:
        "Dashboard interactivo para análisis de estados financieros con KPIs automatizados y visualizaciones dinámicas.",
      image:
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=400&fit=crop",
      tags: ["Power BI", "DAX", "Financial Analysis"],
      metrics: ["Reducción 40% tiempo de reporteo", "15+ KPIs automatizados"],
      // Detalles expandidos para el modal
      detailedInfo: {
        context:
          "Creado para [Nombre de Empresa] como Analista de BI. Dashboard reconstruido con datos ficticios para proteger la confidencialidad.",
        impact:
          "Desarrollo de dashboard de Power BI para reemplazar proceso manual de reporteo, ahorrando a la empresa 80+ horas anuales además de proporcionar capacidades de filtrado dinámico al reporte.",
        businessQuestions: [
          "¿Cuáles son los balances del mes actual y del mes anterior, así como la varianza y porcentaje de varianza?",
          "¿Cuáles son los totales de aging por servicio individual?",
          "¿Cuáles son los totales por tipo de servicio?",
        ],
        process: [
          {
            title: "Extracción y Limpieza de Datos",
            description:
              "Exporté datos crudos del ERP a Excel y los formatee para prepararlos para la ingesta en Power BI.",
          },
          {
            title: "Modelado de Datos",
            description:
              "Se modelaron 8 tablas desde la fuente primaria de datos usando Power Query.",
            image:
              "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=400&fit=crop",
          },
          {
            title: "Creación de Medidas DAX",
            description:
              "15 medidas DAX fueron creadas para calcular KPIs, varianzas porcentuales, y comparaciones mes-a-mes.",
            codeExample: `Mes Anterior Total = 
            CALCULATE(
                SUM(Ventas[Monto]),
          ...
          },
          {
            title: "Publicación y Actualización",
            description:
              "Publiqué al Power BI Service y configuré refresh automático diario.",
          },
        ],
        dashboardBreakdown: [
          "Los filtros son dependientes entre sí y se ajustan basado en las selecciones",
          "KPIs principales en la parte superior, junto a los filtros",
          "Desglose de buckets de aging para cada uno de los KPIs anteriores",
          "Gráfica de barras para visualizar el monto total de aging por equipo",
          "Tabla destacada para exponer balances mayores de individuos específicos",
        ],
        keyInsights: [
          "El área de Ventas representa el 45% del total de la cartera vencida",
          "Los clientes de más de 90 días representan el 23% del total",
          "Se identificaron 5 cuentas críticas que requieren atención inmediata",
        ],
        images: [
